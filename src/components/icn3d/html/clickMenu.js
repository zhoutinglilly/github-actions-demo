...
class ClickMenu {
    ...
    clickMenu1() {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_pdbfile_app', 'click', function (e) {
            let ic = me.icn3d
            //me = me.setIcn3dui($(this).attr('id'));
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_fixedversion', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_fixedversion', 'Open Share Link URL in the archived version of iCn3D')
        })
        me.myEventCls.onIds('#' + me.pre + 'reload_fixedversion', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_blast_rep_id', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_blast_rep_id', 'Align sequence to structure')
        })
        //    },
        //    clkMn1_gi: function() {
        me.myEventCls.onIds('#' + me.pre + 'mn1_gi', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_gi', 'Please input protein gi')
        })

        me.myEventCls.onIds('#' + me.pre + 'mn1_uniprotid', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(['#' + me.pre + 'mn1_delphi', '#' + me.pre + 'mn1_delphi2'], 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportState', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportPdbRes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(['#' + me.pre + 'delphipdb', '#' + me.pre + 'phipdb'], 'click', function (e) {
            let ic = me.icn3d
    ...
    */
        me.myEventCls.onIds(
            ['#' + me.pre + 'delphipqr', '#' + me.pre + 'phipqr', '#' + me.pre + 'phiurlpqr'],
            'click',
            function (e) {
                let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportStlStab', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportVrmlStab', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_exportInteraction', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(['#' + me.pre + 'mn1_exportCanvas', '#' + me.pre + 'saveimage'], 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportCanvas1', 'click', function (e) {
            let ic = me.icn3d
            thisClass.setLogCmd('export canvas 1', true)
            ic.scaleFactor = 1
            ic.shareLinkCls.shareLink(true, true)
        })
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportCanvas2', 'click', function (e) {
            let ic = me.icn3d
            thisClass.setLogCmd('export canvas 2', true)
            ic.scaleFactor = 2
            ic.shareLinkCls.shareLink(true, true)
        })
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportCanvas4', 'click', function (e) {
            let ic = me.icn3d
            thisClass.setLogCmd('export canvas 4', true)
            ic.scaleFactor = 4
            ic.shareLinkCls.shareLink(true, true)
        })
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportCanvas8', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportCounts', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_exportSelections', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_sharelink', 'click', function (e) {
            let ic = me.icn3d
            ic.shareLinkCls.shareLink()
        })
        //    },
        //    clkMn1_replay: function() {
        me.myEventCls.onIds('#' + me.pre + 'mn1_replayon', 'click', function (e) {
            let ic = me.icn3d
            ic.resizeCanvasCls.replayon()
            thisClass.setLogCmd('replay on', true)
        })
        me.myEventCls.onIds('#' + me.pre + 'mn1_replayoff', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_link_structure', 'click', function (e) {
            let ic = me.icn3d
            ...
            if (ic.inputid === undefined) {
                ...
                if (me.cfg.cid !== undefined) {
                    url =
                        ...
                        ic.inputid
                    thisClass.setLogCmd(
                        'link to compounds with structure similar to CID ' + ic.inputid + ': ' + url,
                        false,
                    )
                } else {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_link_pubmed', 'click', function (e) {
            let ic = me.icn3d
            let url
            if (ic.inputid === undefined) {
                let url
                ...
                if (idArray.length === 1) {
                    ...
                    url = 'https://www.ncbi.nlm.nih.gov/pubmed/?term=' + idArray[0] + ' OR ' + idArray[1]
                    thisClass.setLogCmd(
                        'link to literature about PDB ' + idArray[0] + ' OR ' + idArray[1] + ': ' + url,
                        false,
                    )
                }
                window.open(url, '_blank')
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_link_protein', 'click', function (e) {
            let ic = me.icn3d
    ...
    clickMenu2() {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_selectannotations', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_selectdisplayed', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_selectcomplement', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_selectmainchains', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_selectsidechains', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_selectmainsidechains', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_propBfactor', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'applypropbybfactor', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'applypropbypercentout', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_window_table', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_allinteraction', 'Show interactions')
            thisClass.setLogCmd('window interaction table', true)
        })
        me.myEventCls.onIds('#' + me.pre + 'mn1_window_linegraph', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_window_scatterplot', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_window_graph', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(
            ['#' + me.pre + 'mn2_definedsets', '#' + me.pre + 'definedsets', '#' + me.pre + 'definedsets2'],
            'click',
            function (e) {
                let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'setOr', 'click', function (e) {
            let ic = me.icn3d
            ic.setOperation = 'or'
        })
        me.myEventCls.onIds('#' + me.pre + 'setAnd', 'click', function (e) {
            let ic = me.icn3d
            ic.setOperation = 'and'
        })
        me.myEventCls.onIds('#' + me.pre + 'setNot', 'click', function (e) {
            let ic = me.icn3d
            ic.setOperation = 'not'
        })
        //    },
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn2_aroundsphere', 'click', function (e) {
            let ic = me.icn3d
            if (ic.bSetChainsAdvancedMenu === undefined || !ic.bSetChainsAdvancedMenu) {
                let prevHAtoms = me.hashUtilsCls.cloneHash(ic.hAtoms)
                ic.definedSetsCls.setPredefinedInMenu()
            ...
            if ($('#' + me.pre + 'atomsCustomSphere2').length) {
                $('#' + me.pre + 'atomsCustomSphere2').html(
                    "  <option value='selected' selected>selected</option>" + definedAtomsHtml,
                )
            }
        ...
        me.myEventCls.onIds(['#' + me.pre + 'mn2_select_chain', '#' + me.pre + 'definedSets'], 'click', function (e) {
            let ic = me.icn3d
    ...
    clickMenu3() {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsRibbon', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsStrand', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsCylinder', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsSchematic', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsCalpha', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsBackbone', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsBfactor', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsLines', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsStick', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsBallstick', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_proteinsSphere', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_sidecBallstick', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_sidecSphere', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_nuclCartoon', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_nuclBackbone', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_nuclSchematic', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_nuclBallstick', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_ligBallstick', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_ligSchematic', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_glycansCartYes', 'click', function (e) {
            let ic = me.icn3d
            ic.bGlycansCartoon = true
            ic.drawCls.draw()
            thisClass.setLogCmd('glycans cartoon yes', true)
        })
        me.myEventCls.onIds('#' + me.pre + 'mn3_glycansCartNo', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_hydrogensYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_hydrogensNo', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_waterSphere', 'click', function (e) {
            let ic = me.icn3d
    ...
    clickMenu4() {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrSpectrum', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrChain', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrSSGreen', 'click', function (e) {
            let ic = me.icn3d
            ic.sheetcolor = 'green'
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrSSYellow', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrSSSpectrum', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrResidueCustom', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_rescolorfile', 'Please input the file on residue colors')
        })
        //    },
        //    clkMn4_reloadRescolorfile: function() {
        me.myEventCls.onIds('#' + me.pre + 'reload_rescolorfile', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
            if (!me.cfg.notebook) dialog.dialog('close')
        ...
        me.myEventCls.onIds('#' + me.pre + 'reload_customcolorfile', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
            if (!me.cfg.notebook) dialog.dialog('close')
        ...
        me.myEventCls.onIds('#' + me.pre + 'reload_customtubefile', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
            if (!me.cfg.notebook) dialog.dialog('close')
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrHydrophobic', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrAtom', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrConfidence', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'applycolorbyarea', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrBfactorNorm', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrIdentity', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrConserved', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn4_clrApplySave', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn3_styleApplySave', 'click', function (e) {
            let ic = me.icn3d
    ...
    clickMenu5() {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_neighborsYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_neighborsNo', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_surfaceVDW', 'click', function (e) {
            let ic = me.icn3d
            ic.bConsiderNeighbors = false
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_surfaceMolecular', 'click', function (e) {
            let ic = me.icn3d
            ic.bConsiderNeighbors = false
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_surfaceVDWContext', 'click', function (e) {
            let ic = me.icn3d
            ic.bConsiderNeighbors = true
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_surfaceSASContext', 'click', function (e) {
            let ic = me.icn3d
            ic.bConsiderNeighbors = true
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_surfaceMolecularContext', 'click', function (e) {
            let ic = me.icn3d
            ic.bConsiderNeighbors = true
    ...
    */
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_wireframeYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_wireframeNo', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_elecmap2fofc', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_elecmap2fofc', '2Fo-Fc Electron Density Map')
        })
        //    },
        //    clkMn5_elecmapfofc: function() {
        me.myEventCls.onIds('#' + me.pre + 'mn5_elecmapfofc', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(
            ['#' + me.pre + 'delphimapNo2', '#' + me.pre + 'phimapNo2', '#' + me.pre + 'phiurlmapNo2'],
            'click',
            function (e) {
                let ic = me.icn3d
                //ic.setOptionCls.setOption('surface', 'nothing');
        ...
        me.myEventCls.onIds('#' + me.pre + 'applymap2fofc', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
            //if(!me.cfg.notebook) dialog.dialog( "close" );
        ...
        me.myEventCls.onIds('#' + me.pre + 'applymapfofc', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
            //if(!me.cfg.notebook) dialog.dialog( "close" );
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_mapwireframeYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_mapwireframeNo', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(['#' + me.pre + 'mn5_emmapNo', '#' + me.pre + 'emmapNo2'], 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'applyemmap', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
            //if(!me.cfg.notebook) dialog.dialog( "close" );
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_emmapwireframeYes', 'click', function (e) {
            let ic = me.icn3d
            //ic.dsn6ParserCls.dsn6Parser(ic.inputid);
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn5_emmapwireframeNo', 'click', function (e) {
            let ic = me.icn3d
    ...
    clickMenu6() {
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_assemblyYes', 'click', function (e) {
            let ic = me.icn3d
            ic.bAssembly = true
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelAtoms', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelResidues', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelResnum', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelChains', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelTermini', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_addlabelSelection', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_addlabelselection', 'Add custom labels by the selected')
        })
        //    },
        //    clkMn2_saveselection: function() {
        me.myEventCls.onIds('#' + me.pre + 'mn2_saveselection', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_saveselection', 'Save the selected')
        })
        //    },
        //    clkMn6_addlabelNo: function() {
        me.myEventCls.onIds(['#' + me.pre + 'mn6_addlabelNo', '#' + me.pre + 'removeLabels'], 'click', function (e) {
            let ic = me.icn3d
            ic.pickpair = false
            //ic.labels['residue'] = [];
            //ic.labels['custom'] = [];
    ...
    */
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_distanceYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_distTwoSets', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds(
            ['#' + me.pre + 'mn2_selectedcenter', '#' + me.pre + 'zoomin_selection'],
            'click',
            function (e) {
                let ic = me.icn3d
        ...
        me.myEventCls.onIds(
            ['#' + me.pre + 'mn6_resetOrientation', '#' + me.pre + 'resetOrientation'],
            'click',
            function (e) {
                let ic = me.icn3d
        ...
        me.myEventCls.onIds(
            ['#' + me.pre + 'mn6_chemicalbindingshow', '#' + me.pre + 'chemicalbindingshow'],
            'click',
            function (e) {
                let ic = me.icn3d
        ...
        me.myEventCls.onIds(
            ['#' + me.pre + 'mn6_chemicalbindinghide', '#' + me.pre + 'chemicalbindinghide'],
            'click',
            function (e) {
                let ic = me.icn3d
    ...
    */
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_bkgdWhite', 'click', function (e) {
            let ic = me.icn3d
            ic.setStyleCls.setBackground('white')
        })
        //    },
        //    clkMn6_bkgdTransparent: function() {
        me.myEventCls.onIds('#' + me.pre + 'mn6_bkgdTransparent', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_showslabYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_showaxisYes', 'click', function (e) {
            let ic = me.icn3d
            ic.setOptionCls.setOption('axis', 'yes')
            thisClass.setLogCmd('set axis on', true)
        })

        me.myEventCls.onIds('#' + me.pre + 'mn6_showaxisSel', 'click', function (e) {
            let ic = me.icn3d
            ic.pc1 = true
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_symmetry', 'click', function (e) {
            let ic = me.icn3d
            ic.bAxisOnly = false
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_symd', 'click', function (e) {
            let ic = me.icn3d
            ic.bAxisOnly = false
    ...
    */
        ...
        me.myEventCls.onIds(['#' + me.pre + 'mn6_hbondsYes', '#' + me.pre + 'hbondsYes'], 'click', function (e) {
            let ic = me.icn3d
            if (ic.bSetChainsAdvancedMenu === undefined || !ic.bSetChainsAdvancedMenu) {
                let prevHAtoms = me.hashUtilsCls.cloneHash(ic.hAtoms)
                ic.definedSetsCls.setPredefinedInMenu()
        ...
        me.myEventCls.onIds(['#' + me.pre + 'mn6_contactmap'], 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_stabilizerYes', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_stabilizerNo', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_stabilizerOne', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_stabilizerRmOne', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn1_thicknessSet', 'click', function (e) {
            let ic = me.icn3d
            me.htmlCls.dialogCls.openDlg('dl_thickness', 'Set Thickness for 3D Printing')
        })
        //    },
        //    clkmn5_setThickness: function() {
        me.myEventCls.onIds('#' + me.pre + 'mn3_setThickness', 'click', function (e) {
            let ic = me.icn3d
...
*/
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_ssbondsExport', 'click', function (e) {
            let ic = me.icn3d
        ...
        me.myEventCls.onIds('#' + me.pre + 'mn6_clbondsExport', 'click', function (e) {
            let ic = me.icn3d
