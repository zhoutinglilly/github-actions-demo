...
class SetHtml {
    ...
    getLinkWrapper(id, text, wrapper) {
        let me = this.icn3dui,
            ic = me.icn3d
        return (
            "<li id='" +
    ...
    getRadio(radioid, id, text, bChecked) {
        let me = this.icn3dui,
            ic = me.icn3d
        ...
        return (
            ...
            "'" +
            checkedStr +
            "><span class='ui-icon ui-icon-blank'></span> <span class='icn3d-rad-text'>" +
            text +
            '</span></label></li>'
        )
    }

    getRadioColor(radioid, id, text, color, bChecked) {
        let me = this.icn3dui,
            ic = me.icn3d
        let checkedStr = bChecked ? ' checked' : ''
        ...
        return (
            ...
            "'" +
            checkedStr +
            "><span class='ui-icon ui-icon-blank'></span> <span class='icn3d-color-rad-text' color='" +
            color +
    ...
    setAdvanced(index) {
        ...
        html +=
            ...
            'command' +
            indexStr +
            "' placeholder='$[structures].[chains]:[residues]@[atoms]' size='60'></td></tr>"
        html +=
            ...
            'command_name' +
            indexStr +
            "' placeholder='my_selection' size='60'></td></tr>"
        html +=
            ...
            'command_apply' +
            indexStr +
            "'><b>Save Selection to Defined Sets</b></button></td></tr>"
        html += '</table></td>'
        ...
        html +=
            'Specification Tips: <div style="width:20px; margin-top:6px; display:inline-block;"><span id="' +
            me.pre +
            'specguide' +
            indexStr +
            '_expand" class="ui-icon ui-icon-plus icn3d-expand icn3d-link" style="width:15px;" title="Expand"></span><span id="' +
            me.pre +
            'specguide' +
            indexStr +
            '_shrink" class="ui-icon ui-icon-minus icn3d-shrink icn3d-link" style="display:none; width:15px;" title="Shrink"></span></div><br>'
        ...
        html +=
            '<li>Different sets can be unioned(with "<b>or</b>", default), intersected(with "<b>and</b>"), or negated(with "<b>not</b>"). For example, if the "Defined Sets" menu has four sets ":1-10", ":11-20", ":5-15", and ":7-8", the command "saved atoms :1-10 or :11-20 and :5-15 not :7-8" unions all residues 1-10 and 11-20 to get the residues 1-20, then intersects with the residues 5-15 to get the residues 5-15, then exclude the residues 7-8 to get the final residues 5-6 and 9-15.</ul>'
    ...
    getOptionHtml(optArray, selIndex) {
        let me = this.icn3dui,
            ic = me.icn3d
        let html = ''
    ...
    setThicknessHtml(type) {
        ...
        if (type == 'style') {
            ...
            html +=
                ...
                "' size=4>" +
                me.htmlCls.space3 +
                '(for the shininess of the 3D objects, default 40)<br/><br/>'
            ...
            html +=
                ...
                "' size=4>" +
                me.htmlCls.space3 +
                '(for the light strength of the key light, default 0.6)<br/>'
            html +=
                '<b>Fill Light</b>: ' +
                me.htmlCls.inputTextStr +
                "id='" +
                ...
                "' size=4>" +
                me.htmlCls.space3 +
                '(for the light strength of the fill light, default 0.4)<br/>'
            html +=
                '<b>Back Light</b>: ' +
                me.htmlCls.inputTextStr +
                "id='" +
                ...
                "' size=4>" +
                me.htmlCls.space3 +
                '(for the light strength of the back light, default 0.2)<br/><br/>'
        ...
        html +=
            ...
            "' size=4>" +
            me.htmlCls.space3 +
            '(for stabilizers, hydrogen bonds, distance lines, default 0.1)<br/>'
        html +=
            '<b>Coil Radius</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
        ...
        html +=
            ...
            "' size=4>" +
            me.htmlCls.space3 +
            "(for C alpha trace, O3' trace, default 0.2)<br/>"

        html +=
            '<b>Ribbon Thickness</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            'ribbonthick_' +
            ...
            "' size=4>" +
            me.htmlCls.space3 +
            '(for helix and sheet ribbons, nucleotide ribbons, default 0.2)<br/>'
        html +=
            '<b>Protein Ribbon Width</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            'prtribbonwidth_' +
            ...
            "' size=4>" +
            me.htmlCls.space3 +
            '(for helix and sheet ribbons, default 1.3)<br/>'
        html +=
            '<b>Nucleotide Ribbon Width</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            'nucleotideribbonwidth_' +
            type +
            "' value='" +
            nucleotideribbonwidth +
            "' size=4>" +
            me.htmlCls.space3 +
            '(for nucleotide ribbons, default 0.8)<br/>'
        ...
        html +=
            ...
            "' size=4>" +
            me.htmlCls.space3 +
            "(for styles 'Ball and Stick' and 'Dot', default 0.3)<br/>"

        if (type == 'style') {
            html +=
                '<br><b>4. Show Glycan Cartoon</b>: ' +
                me.htmlCls.inputTextStr +
                "id='" +
                me.pre +
                "glycan' value='" +
        ...
        html +=
            me.htmlCls.spanNowrapStr + '' + me.htmlCls.buttonStr + 'reset_thickness_' + type + "'>Reset</button></span>"
    ...
    setSequenceGuide(suffix, bShown) {
        let me = this.icn3dui,
            ic = me.icn3d
        let sequencesHtml = ''
        ...
        if (bShown) {
            ...
            sequencesHtml +=
                '<div style="width:20px; margin-left:3px; display:inline-block;"><span id="' +
                me.pre +
                'seqguide' +
                suffix +
                '_expand" class="ui-icon ui-icon-plus icn3d-expand icn3d-link" style="width:15px;" title="Expand"></span><span id="' +
                ...
                'seqguide' +
                suffix +
                '_shrink" class="ui-icon ui-icon-minus icn3d-shrink icn3d-link" style="display:none; width:15px;" title="Shrink"></span></div> '

            sequencesHtml +=
                "<div style='min-width:200px; display:inline-block;'><b>Selection:</b> Name: " +
                me.htmlCls.inputTextStr +
                "id='" +
                me.pre +
                'seq_command_name' +
            ...
            sequencesHtml +=
                ...
                'seqguide' +
                suffix +
                "' style='display:none; white-space:normal;' class='icn3d-box'>"
        }

        sequencesHtml += this.getSelectionHints()

        let resCategories =
            "<b>Residue labeling:</b> standard residue with coordinates: UPPER case letter; nonstandard residue with coordinates: the first UPPER case letter plus a period except that water residue uses the letter 'O'; residue missing coordinates: lower case letter."
        let scroll =
            me.utilsCls.isMac() && !me.utilsCls.isMobile()
                ? '<br/><br/><b>Turn on scroll bar:</b> System preferences -> General -> show scroll bars -> check Always'
                : ''
    ...
    setAlignSequenceGuide(suffix, bShown) {
        let me = this.icn3dui,
            ic = me.icn3d
        let sequencesHtml = ''
        suffix = ''
        ...
        sequencesHtml +=
            ...
            "id='" +
            me.pre +
            "alignseq_command_name' value='alseq_" +
            index +
            "' size='10'> " +
            me.htmlCls.space2 +
            "<button style='white-space:nowrap;' id='" +
            me.pre +
            "alignseq_saveselection'>Save</button> <button style='white-space:nowrap; margin-left:20px;' id='" +
            me.pre +
            "alignseq_clearselection'>Clear</button></div><br/>"
        ...
        let resCategories =
            '<b>Residue labeling:</b> aligned residue with coordinates: UPPER case letter; non-aligned residue with coordinates: lower case letter which can be highlighted; residue missing coordinates: lower case letter which can NOT be highlighted.'
        let scroll =
            me.utilsCls.isMac() && !me.utilsCls.isMobile()
                ? '<br/><br/><b>Turn on scroll bar:</b> System preferences -> General -> show scroll bars -> check Always'
                : ''
    ...
    getSelectionHints() {
        ...
        if (!me.utilsCls.isMobile()) {
            sequencesHtml +=
                '<b>Select on 1D sequences:</b> drag to select, drag again to deselect, multiple selection is allowed without Ctrl key, click "Save Selection" to save the current selection.<br/><br/>'

            sequencesHtml +=
                '<b>Select on 2D interaction diagram:</b> click on the nodes or lines. The nodes are chains and can be united with the Ctrl key. The lines are interactions and can NOT be united. Each click on the lines selects half of the lines, i.e., select the interacting residues in one of the two chains.<br/><br/>'

            let tmpStr = me.utilsCls.isMobile() ? 'use finger to pick' : 'hold "Alt" and use mouse to pick'
            sequencesHtml +=
                '<b>Select on 3D structures:</b> ' +
                tmpStr +
                ', click the second time to deselect, hold "Ctrl" to union selection, hold "Shift" to select a range, press the up/down arrow to switch among atom/residue/strand/chain/structure, click "Save Selection" to save the current selection.<br/><br/>'

            sequencesHtml +=
                '<b>Save the current selection</b>(either on 3D structure, 2D interactions, or 1D sequence): open the menu "Select -> Save Selection", specify the name and description for the selection, and click "Save".<br/><br/>'
        } else {
            sequencesHtml +=
                '<b>Select Aligned Sequences:</b> touch to select, touch again to deselect, multiple selection is allowed without Ctrl key, click "Save Selection" to save the current selection.<br/>'
        }
    ...
    addGsizeSalt(name) {
        ...
        html +=
            "<span style='white-space:nowrap;font-weight:bold;margin-left:30px;'>Salt Concentration: <select id='" +
            me.pre +
            name +
            "salt'>"
    ...
    getFootHtml(type, tabName) {
        ...
        if (type == 'delphi') {
            if (me.cfg.cid) {
                ...
                footHtml +=
                    "<b>Note</b>: Only the selected residues are used for <a href='http://honig.c2b2.columbia.edu/delphi'>DelPhi</a> potential calculation by solving linear Poisson-Boltzmann equation."
            ...
            if (type == 'url')
                footHtml +=
                    'The PQR or potential file can be accessed in a URL if it is located in the same host as iCn3D.'
    ...
    getPotentialHtml(type, dialogClass) {
        let me = this.icn3dui,
            ic = me.icn3d
        let html = ''
        ...
        html +=
            "<span style='white-space:nowrap;font-weight:bold;'>Potential contour at: <select id='" +
            me.pre +
            name1 +
            "contour'>"
        ...
        if (type == 'delphi') {
            html +=
                me.htmlCls.buttonStr + 'reload_' + name1 + "file' style='margin-top: 6px;'>Equipotential Map</button>"
            ...
            htmlTmp =
                ...
                me.htmlCls.buttonStr +
                name1 +
                "mapNo'>Remove Map</button></span></div>"
            ...
            html +=
                ...
                'reload_' +
                name0 +
                "file' style='margin-top: 6px;'>Equipotential Map</button>" +
                htmlTmp
        ...
        html +=
            "<span style='white-space:nowrap;font-weight:bold;'>Surface with max potential at: <select id='" +
            me.pre +
            name1 +
            "contour2'>"
        ...
        if (type == 'delphi') {
            html +=
                ...
                'reload_' +
                name1 +
                "file2' style='margin-top: 6px;'>Surface with Potential</button>"
            ...
            htmlTmp =
                ...
                me.htmlCls.buttonStr +
                name1 +
                "mapNo2'>Remove Surface</button></span></div>"
    ...
    */
    ...
    clickReload_pngimage() {
        let me = this.icn3dui,
            ic = me.icn3d
        if (me.bNode) return

        let thisClass = this
        me.myEventCls.onIds('#' + me.pre + 'reload_pngimage', 'click', function (e) {
            let ic = me.icn3d
            e.preventDefault()
...
*/
    ...
    loadPng(imageStr) {
        ...
        if (pos == -1 && posState == -1) {
            ...
            if (ic.bInputfile) {
                let posDataEnd = imageStr.indexOf('End of data file======\n')
                let data = imageStr.substr(
                    posData + matchedStrData.length,
                    posDataEnd - posData - matchedStrData.length,
                )
                ic.InputfileData = data
                ...
                let posType = imageStr.indexOf(matchedStrType)
                let posTypeEnd = imageStr.indexOf('End of type file======\n')
                let type = imageStr.substr(
                    posType + matchedStrType.length,
                    posTypeEnd - posType - matchedStrType.length - 1,
                ...
                //var posState = imageStr.indexOf(matchedStrState);
                let posStateEnd = imageStr.indexOf('End of state file======\n')
                let statefile = imageStr.substr(
                    posState + matchedStrState.length,
                    posStateEnd - posState - matchedStrState.length,
                )
                statefile = decodeURIComponent(statefile)
                if (type === 'pdb') {
                    $.when(ic.pdbParserCls.loadPdbData(data)).then(function () {
                        ic.commands = []
                        ic.optsHistory = []
                        ic.loadScriptCls.loadScript(statefile, true)
                    })
    ...
    setLineThickness(postfix, bReset) {
        let me = this.icn3dui,
            ic = me.icn3d
