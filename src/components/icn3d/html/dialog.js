...
class Dialog {
        ...
        if (this.dialogHashSave === undefined || !this.dialogHashSave.hasOwnProperty(id)) {
            $('#' + id)
                ...
                .append(
                    "<span pid='" +
                        id +
                        "' class='icn3d-saveicon ui-icon ui-icon-disk' title='Save as an HTML file'></span>",
                )
        ...
        if (this.dialogHashHide === undefined || !this.dialogHashHide.hasOwnProperty(id)) {
            $('#' + id)
                ...
                .append(
                    "<span pid='" +
                        id +
                        "' class='icn3d-hideicon ui-icon ui-icon-arrowthick-2-ne-sw' title='Resize the window'></span>",
                )
    ...
    getDialogStatus() {
        ...
        if (bSelectannotationsInit)
            status.bSelectannotationsInit2 = $('#' + me.pre + 'dl_selectannotations').dialog('isOpen')
    ...
    openDlgHalfWindow(id, title, dialogWidth, bForceResize) {
        let me = this.icn3dui,
            ic = me.icn3d
        if (me.bNode) return
        ...
        window.dialog = $('#' + id).dialog({
            ...
            close: function (e) {
                ...
                if (
                    (id === me.pre + 'dl_selectannotations' &&
                        !status.bAlignmentInit2 &&
                        !status.bGraph2 &&
                        !status.bTable2 &&
                        !status.bLineGraph2 &&
                        !status.bScatterplot2 &&
                        !status.bContactmap2) ||
                    (id === me.pre + 'dl_graph' &&
                        !status.bSelectannotationsInit2 &&
                        !status.bAlignmentInit2 &&
                        !status.bTable2 &&
                        !status.bLineGraph2 &&
                        !status.bScatterplot2 &&
                        !status.bContactmap2) ||
                    (id === me.pre + 'dl_alignment' &&
                        !status.bSelectannotationsInit2 &&
                        !status.bGraph2 &&
                        !status.bTable2 &&
                        !status.bLineGraph2 &&
                        !status.bScatterplot2 &&
                        !status.bContactmap2) ||
                    (id === me.pre + 'dl_interactionsorted' &&
                        !status.bSelectannotationsInit2 &&
                        !status.bGraph2 &&
                        !status.bAlignmentInit2 &&
                        !status.bLineGraph2 &&
                    ...
                    if (status.bTwoddgmInit2 || status.bTwodctnInit2 || status.bSetsInit2) {
                        ...
                        if (status.bTwoddgmInit2)
                            thisClass.openDlg2Ddgm(me.pre + 'dl_2ddgm', undefined, status.bSetsInit2)
                        if (status.bTwodctnInit2)
                            thisClass.openDlg2Ddgm(me.pre + 'dl_2dctn', undefined, status.bSetsInit2)
            ...
            resize: function (e) {
                if (id == me.pre + 'dl_selectannotations') {
                    ...
                    let oriWidth =
                        status.bTwoddgmInit2 || status.bSetsInit2
                            ? (me.htmlCls.WIDTH - twoddgmWidth) / 2
                            : me.htmlCls.WIDTH / 2
    ...
    openDlg2Ddgm(id, inHeight, bDefinedSets) {
        let me = this.icn3dui,
            ic = me.icn3d
        if (me.bNode) return
        ...
        let position = {
            my: 'left top+' + me.htmlCls.MENU_HEIGHT,
            at: at,
            of: '#' + me.pre + 'viewer',
            collision: 'none',
        }
    ...
    openDlgRegular(id, title) {
        ...
        if (
            ...
            if (me.htmlCls.WIDTH >= me.htmlCls.HEIGHT) {
                ...
                if (status.bTwoddgmInit2 || status.bTwodctnInit2 || status.bSetsInit2) {
                    ic.resizeCanvasCls.resizeCanvas(
                        me.htmlCls.WIDTH - dialogWidth - twoddgmWidth,
                        me.htmlCls.HEIGHT,
                        true,
                    )
                ...
                window.dialog = $('#' + id).dialog({
                    ...
                    close: function (e) {
                        if (
                            ...
                            if (status.bTwoddgmInit2 || status.bTwodctnInit2 || status.bSetsInit2) {
                                let canvasWidth = me.utilsCls.isMobile()
                                    ? me.htmlCls.WIDTH
                                    : me.htmlCls.WIDTH - twoddgmWidth
                                ic.resizeCanvasCls.resizeCanvas(canvasWidth, me.htmlCls.HEIGHT, true)
