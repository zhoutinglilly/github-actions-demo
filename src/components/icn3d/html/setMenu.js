...
class SetMenu {
    ...
    setTopMenusHtml(id, str1, str2) {
        ...
        if (!me.cfg.simplemenu) {
            ...
            html +=
                "<div class='icn3d-commandTitle' style='min-width:40px; margin-top: 3px; white-space: nowrap;'>" + str2

            html +=
                tdStr +
                '<div class="icn3d-commandTitle" style="white-space:nowrap; margin-top:10px; border-left:solid 1px #888888"><span id="' +
                me.pre +
                'selection_expand" class="icn3d-expand icn3d-link" title="Expand">' +
                me.htmlCls.space2 +
        ...
        html +=
            "<canvas id='" +
            me.pre +
            "canvas' style='width:100%; height: 100%; background-color: #000;'>Your browser does not support WebGL.</canvas>"
    ...
    setTopMenusHtmlMobile(id, str1, str2) {
        ...
        if (!me.utilsCls.isMobile()) {
            ...
            html +=
                ...
                "fullscreen' style='position:absolute; z-index:1999; display:block; padding:0px; margin: 7px 0px 0px " +
                marginLeft +
        ...
        // show title at the top left corner
        let titleColor =
            me.htmlCls.opts['background'] == 'white' || me.htmlCls.opts['background'] == 'grey'
                ? 'black'
                : me.htmlCls.GREYD
    ...
    setReplayHtml(id) {
        ...
        html += '</svg></div>'
        html +=
            me.htmlCls.divStr + "replay_menu' style='background-color:#DDDDDD; padding:3px; font-weight:bold;'></div>"
    ...
    setTools() {
        ...
        html +=
            me.htmlCls.divStr +
            "selection' style='display:none;'><div style='position:absolute; z-index:555; float:left; display:table-row; margin: 32px 0px 0px 3px;'>"
    ...
    setTools_base() {
        ...
        html +=
            tdStr +
            this.setButton(buttonStyle, 'saveimage', 'Save iCn3D PNG Image', 'Save iCn3D<br/>PNG Image') +
            '</td>'

        if (me.cfg.cid === undefined) {
            html +=
                tdStr +
                this.setButton(buttonStyle, 'hbondsYes', 'View H-Bonds & Interactions', 'H-Bonds &<br/> Interactions') +
                '</td>'
        }

        html +=
            tdStr +
            this.setButton(buttonStyle, 'show_selected', 'View ONLY the selected atoms', 'View<br/> Selection') +
            '</td>'
        ...
        html +=
            ...
            this.setButton(
                buttonStyle,
                'toggleHighlight',
                'Turn on and off the 3D highlight in the viewer',
                'Toggle<br/>Highlight',
            ) +
            '</td>'
    ...
    setMenu1_base() {
        ...
        html += '<ul>'
        html += me.htmlCls.setHtmlCls.getRadio(
            'mn2_realign',
            'mn2_realignonseqalign',
            'on Sequence Alignment ' + me.htmlCls.wifiStr,
            true,
        )
    ...
    */
    ...
    setMenu2b_base() {
        ...
        html +=
            "<li id='" +
            me.pre +
            "mn2_alternateWrap'><span id='" +
            me.pre +
            "mn2_alternate' class='icn3d-link'>Alternate(Key \"a\")</span></li>"
        ...
        if (me.cfg.opmid !== undefined) {
            html +=
                ...
                "togglememli'><span id='" +
                me.pre +
                "togglemem' class='icn3d-link'>Toggle Membrane</span></li>"
            html +=
                "<li id='" +
                me.pre +
                "adjustmemli'><span id='" +
                me.pre +
                "adjustmem' class='icn3d-link'>Adjust Membrane</span></li>"
            html +=
                "<li id='" +
                me.pre +
                "selectplaneli'><span id='" +
                me.pre +
                "selectplane' class='icn3d-link'>Select between<br>Two X-Y Planes</span></li>"
        } else {
            html +=
                "<li id='" +
                me.pre +
                "togglememli' style='display:none'><span id='" +
                me.pre +
                "togglemem' class='icn3d-link'>Toggle Membrane</span></li>"
            html +=
                "<li id='" +
                me.pre +
                "adjustmemli' style='display:none'><span id='" +
                me.pre +
                "adjustmem' class='icn3d-link'>Adjust Membrane</span></li>"
            html +=
                "<li id='" +
                me.pre +
                "selectplaneli' style='display:none'><span id='" +
                me.pre +
                "selectplane' class='icn3d-link'>Select between<br>Two X-Y Planes</span></li>"
        }
    ...
    setMenu4_base() {
        ...
        if (me.cfg.cid === undefined) {
            ...
            html += me.htmlCls.setHtmlCls.getRadio(
                'mn4_clr',
                'mn4_clrHydrophobic',
                'Wimley-White<br><span style="padding-left:1.5em;">Hydrophobicity</span>',
            )
            ...
            if (!me.cfg.hidelicense)
                html += me.htmlCls.setHtmlCls.getRadio(
                    'mn4_clr',
                    'mn1_delphi2',
                    'DelPhi<br><span style="padding-left:1.5em;">Potential ' + me.htmlCls.licenseStr + '</span>',
                )
    ...
    setMenu5_base() {
        ...
        if (me.cfg.cid === undefined) {
            ...
            html += '<ul>'
            if (bOnePdb)
                html += me.htmlCls.setHtmlCls.getLink('mn6_symmetry', 'from PDB(precalculated) ' + me.htmlCls.wifiStr)
    ...
    setMenu6_base() {
        ...
        html +=
            liStr +
            me.htmlCls.baseUrl +
            "icn3d/icn3d.html#about' target='_blank'>About iCn3D<span style='font-size:0.9em'> " +
            me.REVISION +
            '</span></a></li>'
        ...
        html +=
            liStr +
            me.htmlCls.baseUrl +
            "icn3d/icn3d.html#gallery' target='_blank'>Live Gallery " +
            me.htmlCls.wifiStr +
            '</a></li>'
        ...
        html +=
            liStr +
            "https://www.ncbi.nlm.nih.gov/structure' target='_blank'>Search Structure " +
            me.htmlCls.wifiStr +
            '</a></li>'
        ...
        html +=
            liStr +
            "https://github.com/ncbi/icn3d' target='_blank'>GitHub (browser) " +
            me.htmlCls.wifiStr +
            '</a></li>'
        html +=
            liStr +
            "https://www.npmjs.com/package/icn3d' target='_blank'>npm (Node.js) " +
            me.htmlCls.wifiStr +
            '</a></li>'
        html +=
            liStr +
            "https://pypi.org/project/icn3dpy' target='_blank'>Jupyter Notebook " +
            me.htmlCls.wifiStr +
            '</a></li>'
        html += '</ul>'
        html += '</li>'
        ...
        html +=
            liStr + me.htmlCls.baseUrl + "icn3d/icn3d.html#modifyfunction' target='_blank'>Modify Functions</a></li>"
        html += '</ul>'
        html += '</li>'
        ...
        html +=
            liStr +
            me.htmlCls.baseUrl +
            "icn3d/docs/icn3d_help.html' target='_blank'>Help Doc " +
            me.htmlCls.wifiStr +
            '</a></li>'
