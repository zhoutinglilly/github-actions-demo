...
class SetDialog {
    ...
    setDialogs() {
        ...
        html +=
            me.htmlCls.divStr + "dl_2ddgm' class='" + dialogClass + " icn3d-dl_2ddgm' style='background-color:white'>"
        html += '</div>'

        html +=
            me.htmlCls.divStr + "dl_2dctn' class='" + dialogClass + " icn3d-dl_2dctn' style='background-color:white'>"
        ...
        html +=
            "<svg id='" + me.svgid_ct + "' viewBox='" + '0,0,' + me.htmlCls.width2d + ',' + me.htmlCls.width2d + "'>"
        html += '</svg>'
        ...
        html +=
            me.htmlCls.divStr + "alignseqguide_wrapper'><br>" + me.htmlCls.setHtmlCls.setAlignSequenceGuide() + '</div>'
        ...
        html +=
            me.htmlCls.space3 +
            '<span class="icn3d-square" style="background-color: rgb(255, 125, 69);">&nbsp;</span> <span>Very low (pLDDT &lt; 50)</span><br><br>'
        ...
        html +=
            "Enter the PDB IDs or MMDB IDs of two structures that have been found to be similar by <A HREF=' " +
            me.htmlCls.baseUrl +
            "vastplus/vastplus.cgi'>VAST+</A> : <br/><br/>ID1: " +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            "alignid1' value='1HHO' size=8>" +
            me.htmlCls.space3 +
            me.htmlCls.space3 +
            'ID2: ' +
            me.htmlCls.inputTextStr +
        ...
        html +=
            ...
            me.htmlCls.space3 +
            me.htmlCls.buttonStr +
            "reload_align_refined'>Invariant Substructure Superposed</button>"
        html += '</div>'
    ...
    */
        ...
        html +=
            'All chains will be aligned to the first chain in the comma-separated chain IDs. Each chain ID has the form of pdbid_chain(e.g., 1HHO_A, case sensitive).<br/><br/>'
        html +=
            '<b>Chain IDs</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            "chainalignids' value='1HHO_A,4N7N_A,2HCO_A' size=50><br/><br/>"
        html += '<b>Optional 1</b>, full chains are used for structure alignment<br/><br/>'
        html +=
            '<b>Optional 2</b>, sequence alignment (followed by structure alignemnt) based on residue numbers in the First/Master chain: <br>' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            "resalignids' placeholder='1,5,10-50' size=50><br/><br/>"
        html +=
            "<b>Optional 3</b>, predefined alignment with residue numbers in each chain specified (one chain per line): <br><textarea id='" +
            me.pre +
            "predefinedres' rows='5' style='width: 100%; height: " +
            me.htmlCls.LOG_HEIGHT +
            "px; padding: 0px; border: 0px;' placeholder='1,5,10-50\n1,5,10-50\n1,5,10-50'></textarea><br/><br/>"
        html +=
            me.htmlCls.buttonStr +
            "reload_chainalign'>Align Biological Unit</button>" +
            me.htmlCls.buttonStr +
            "reload_chainalign_asym' style='margin-left:30px'>Align Asymmetric Unit</button><br/><br/>"
        html +=
            '(Note: To align chains in custom PDB files, you could concatenate PDB files in a single PDB file with the separation line "ENDMDL". Then load it in "Open File > PDB File" in the "File" menu and click "View Sequences & Annotations" in the "Window" menu. Finally select multiple chains in the sequence window and click "Realign Selection" in the "File" menu.)<br><br>'
        html += '</div></div>'

        html += me.htmlCls.divStr + "dl_mutation' class='" + dialogClass + "'>"
        html += "<div style='width:500px'>"
        html +=
            'Please specify the mutations with a comma separated mutation list. Each mutation can be specified as "[PDB ID]_[Chain ID]_[Residue Number]_[One Letter Mutatnt Residue]". E.g., the mutation of N501Y in the E chain of PDB 6M0J can be specified as "6M0J_E_501_Y". <br/><br/>'
        html +=
        ...
        html +=
            "Enter a Sequence ID(or FASTA sequence) and the aligned Structure ID, which can be found using the <a href='https://blast.ncbi.nlm.nih.gov/Blast.cgi?PROGRAM=blastp&PAGE_TYPE=BlastSearch&DATABASE=pdb' target='_blank'>BLAST</a> search against the pdb database with the Sequence ID or FASTA sequence as input.<br><br> "
        html +=
        ...
        html +=
            '<b>Structure ID</b>(NCBI protein accession of a chain of a 3D structure): ' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
        ...
        html +=
            ...
            "dsn6file2fofc'> " +
            me.htmlCls.buttonStr +
            "reload_dsn6file2fofc' style='margin-top: 6px;'>Load</button><br><br><br/>"
        ...
        html +=
            ...
            "dsn6filefofc'> " +
            me.htmlCls.buttonStr +
            "reload_dsn6filefofc' style='margin-top: 6px;'>Load</button><br><br><br>"
    ...
    */
        ...
        html +=
            "<span style='white-space:nowrap;'>" + me.htmlCls.buttonStr + "applycontactmap'>Display</button></span><br>"
        html += '</div>'
        ...
        html +=
            ...
            me.htmlCls.buttonStr +
            "sortSet2' style='margin-left:20px'>Set 2</button></div><br>"

        html +=
            "<div style='text-indent:1.1em'>" +
            me.htmlCls.buttonStr +
            "hbondLineGraph'>2D Interaction Network</button> to show interactions between two lines of residue nodes</div><br>"

        html +=
            "<div style='text-indent:1.1em'>" +
            me.htmlCls.buttonStr +
            "hbondScatterplot'>2D Interaction Map</button> to show interactions as map</div><br>"
        ...
        html +=
            me.htmlCls.divNowrapStr +
            '1. Select sets from two structures below <br>or use your current selection:</div><br>'
        html +=
        ...
        html +=
            "<span style='white-space:nowrap;font-weight:bold;'>Contour at: <select id='" + me.pre + "empercentage'>"
        ...
        html +=
            '2. Size: ' + me.htmlCls.inputTextStr + "id='" + me.pre + "labelsize' value='18' size=4 maxlength=2><br/>"
        ...
        html +=
            '2. Size: ' + me.htmlCls.inputTextStr + "id='" + me.pre + "labelsize2' value='18' size=4 maxlength=2><br/>"
        html += '3. Color: ' + me.htmlCls.inputTextStr + "id='" + me.pre + "labelcolor2' value='ffff00' size=4><br/>"
        html +=
            '4. Background: ' + me.htmlCls.inputTextStr + "id='" + me.pre + "labelbkgd2' value='cccccc' size=4><br/>"
        html +=
            me.htmlCls.spanNowrapStr + '5. ' + me.htmlCls.buttonStr + "applyselection_labels'>Display</button></span>"
        html += '</div>'
        ...
        html +=
            ...
            "id='" +
            me.pre +
            "distancecolor' value='ffff00' size=4><br/>"
        html +=
            me.htmlCls.spanNowrapStr +
            '3. ' +
            me.htmlCls.buttonStr +
        ...
        html +=
            ...
            "id='" +
            me.pre +
            "distancecolor2' value='ffff00' size=4><br/><br/>"
        ...
        html +=
            me.htmlCls.spanNowrapStr + '2. ' + me.htmlCls.buttonStr + "applypick_stabilizer_rm'>Remove</button></span>"
        html += '</div>'
        ...
        html +=
            '<div style=\'width:600px\'>The full protein sequences with gaps are listed one by one. The sequence of the structure is listed at the top. If there are non-gap residues(e.g., from RefSeq) outside of the sequence of the structure, please remove them. Each sequence has a title line starting with ">".</div><br>'
        ...
        html +=
            'Track Text(e.g., "152 G, 155-156 RR" defines a character "G" at the position 152 and two continuous characters "RR" at positions from 155 to 156. The starting position is 1): <br>'
        html +=
            "<textarea id='" +
            me.pre +
        ...
        html +=
            tmpStr1 + me.htmlCls.inputCheckStr + "id='" + me.pre + "anno_all'>All" + me.htmlCls.space2 + '</span></td>'
        html +=
            tmpStr2 +
            me.htmlCls.inputCheckStr +
            "id='" +
        ...
        html +=
            ...
            '</span></td>'
        html +=
            tmpStr1 + me.htmlCls.inputCheckStr + "id='" + me.pre + "anno_snp'>SNPs" + me.htmlCls.space2 + '</span></td>'
        html +=
            tmpStr1 +
            me.htmlCls.inputCheckStr +
            "id='" +
        ...
        if (me.cfg.opmid !== undefined) {
            html +=
                "<td style='min-width:110px;'><span id='" +
                me.pre +
                "anno_transmemli' style='white-space:nowrap'>" +
                me.htmlCls.inputCheckStr +
                "id='" +
                me.pre +
            ...
            html +=
                "<td style='min-width:110px;'><span id='" +
                me.pre +
                "anno_transmemli' style='display:none; white-space:nowrap'>" +
                me.htmlCls.inputCheckStr +
                "id='" +
                me.pre +
                "anno_transmem'>Transmembrane" +
        ...
        html +=
            '<br><b>Alignment RMSD</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
            me.pre +
            "realignrmsd' value='35' size='10'>&#8491;<br><br>"
        html += '</div>'
        ...
        html +=
            "<div style='width:400px'>Select residue based on B-factor. The values are in the range of 0-100.</div><br>"
        html +=
            '<b>Min B-factor</b>: ' +
            me.htmlCls.inputTextStr +
            "id='" +
