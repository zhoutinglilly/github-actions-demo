...
class HashUtilsCls {
    ...
    exclHash(includeAtomsInput, excludeAtoms) {
        let me = this.icn3dui
    ...
    unionHashInPlace(atoms1, atoms2) {
        let me = this.icn3dui
        if (atoms1 === undefined) atoms1 = {}
        if (atoms2 === undefined) atoms2 = {}
    ...
    unionHashNotInPlace(atoms1, atoms2) {
        let me = this.icn3dui
    ...
    intHash2Atoms(atoms1, atoms2, allAtoms) {
        let me = this.icn3dui
    ...
    exclHash2Atoms(includeAtoms, excludeAtoms, allAtoms) {
        let me = this.icn3dui
    ...
    unionHash2Atoms(atoms1, atoms2, allAtoms) {
        let me = this.icn3dui
