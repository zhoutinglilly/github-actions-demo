...
class UtilsCls {
    ...
    hasCovalentBond(atom0, atom1) {
        let me = this.icn3dui
        let r =
            me.parasCls.covalentRadii[atom0.elem.toUpperCase()] + me.parasCls.covalentRadii[atom1.elem.toUpperCase()]
    ...
    setViewerWidthHeight(me) {
        ...
        if (me.oriWidth !== undefined && me.cfg.width.toString().indexOf('%') === -1) {
            ...
            if (me.cfg.width.toString().indexOf('%') !== -1) {
                viewer_width =
                    ($(window).width() * me.cfg.width.substr(0, me.cfg.width.toString().indexOf('%'))) / 100.0 -
                    me.htmlCls.LESSWIDTH
            } else {
            ...
            if (me.cfg.height.toString().indexOf('%') !== -1) {
                viewer_height =
                    ($(window).height() * me.cfg.height.substr(0, me.cfg.height.toString().indexOf('%'))) / 100.0 -
                    me.htmlCls.EXTRAHEIGHT -
                    me.htmlCls.LESSHEIGHT
            } else {
