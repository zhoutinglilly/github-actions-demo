...
class DrawGraph {
    ...
    drawGraph(jsonStr, divid) {
        ...
        if (typeof d3v4 == 'undefined') var d3v4 = d3
        ...
        var rect = gMain.append('rect').attr('width', parentWidth).attr('height', parentHeight).style('fill', '#FFF')
        ...
        var link = gDraw
            ...
            .attr('stroke-width', function (d) {
                if (
                    d.v == me.htmlCls.contactValue ||
                    d.v == me.htmlCls.contactInsideValue ||
                    d.v == me.htmlCls.hbondInsideValue ||
                    d.v == me.htmlCls.ionicInsideValue ||
                    d.v == me.htmlCls.halogenInsideValue ||
                    d.v == me.htmlCls.picationInsideValue ||
                    d.v == me.htmlCls.pistackingInsideValue
                )
                    return '1px'
                else if (
                    d.v == me.htmlCls.hbondValue ||
                    d.v == me.htmlCls.ionicValue ||
                    d.v == me.htmlCls.halogenValue ||
                    d.v == me.htmlCls.picationValue ||
                    d.v == me.htmlCls.pistackingValue
                )
                    return '2px'
        ...
        var allNodes = gDraw.append('g').attr('class', 'node')
                ...
                d3v4
                    ...
                    .strength(function (d) {
                        if (!me.htmlCls.force) {
                            ...
                            if (d.v == me.htmlCls.ssValue) {
                                // secondary
                                return !isNaN(dist_ss) ? dist_ss / 100.0 : 1
                            } else if (d.v == me.htmlCls.coilValue || d.v == me.htmlCls.clbondValue) {
                                // coil
                                return !isNaN(dist_coil) ? dist_coil / 100.0 : 0.5
                            } else if (d.v == me.htmlCls.hbondValue || d.v == me.htmlCls.hbondInsideValue) {
                                // hydrogen bonds
                                return !isNaN(dist_hbond) ? dist_hbond / 100.0 : 0.5
                            } else if (d.v == me.htmlCls.contactValue || d.v == me.htmlCls.contactInsideValue) {
                                // interactions
                                return !isNaN(dist_inter) ? dist_inter / 100.0 : 0.25
                            } else if (d.v == me.htmlCls.ssbondValue) {
                                // hydrogen bonds
                                return !isNaN(dist_ssbond) ? dist_ssbond / 100.0 : 0.5
                            } else if (d.v == me.htmlCls.ionicValue || d.v == me.htmlCls.ionicInsideValue) {
                                // ionic interaction
        ...
        if (me.htmlCls.force == 1) {
            ...
            me.htmlCls.simulation
                ...
                .force(
                    'y',
                    d3v4.forceY(parentHeight / 2).strength(function (d) {
                        return 0.02
                    }),
                )
        } else if (me.htmlCls.force == 2) {
            // y-axis
            me.htmlCls.simulation
                .force(
                    'y',
                ...
                .force(
                    'x',
                    d3v4.forceX(parentWidth / 2).strength(function (d) {
                        return 0.02
                    }),
                )
        } else if (me.htmlCls.force == 3) {
            // circle
            me.htmlCls.simulation.force(
                'r',
                d3v4
                    .forceRadial(
                        function (d) {
        ...
        me.htmlCls.simulation.nodes(graph.nodes).on('tick', ticked)

        me.htmlCls.simulation.force('link').links(graph.links)
        ...
        function ticked() {
            ...
            link.attr('x1', function (d) {
                ...
                .attr('y1', function (d) {
                    var ret = parentHeight - d.source.y
                    return !isNaN(ret) ? ret : 0
                })
                .attr('x2', function (d) {
                    var ret = d.target.x
                ...
                .attr('y2', function (d) {
                    var ret = parentHeight - d.target.y
                    return !isNaN(ret) ? ret : 0
                })
        ...
        function brushed() {
            ...
            node.classed('selected', function (d) {
                return (d.selected =
                    ...
                    (extent[0][0] <= d.x &&
                        d.x < extent[1][0] &&
                        extent[0][1] <= parentHeight - d.y &&
                        parentHeight - d.y < extent[1][1]))
            })
        }
