...
class Saltbridge {
    ...
    calculateIonicInteractions(startAtoms, targetAtoms, threshold, bSaltbridge, type, bInternal) {
        let ic = this.icn3d,
            me = ic.icn3dui
        ...
        for (let i in startAtoms) {
            ...
            let bAtomCondCation =
                ((atom.resn === 'LYS' || atom.resn === 'HIS') && atom.elem === 'N' && atom.name !== 'N') ||
            ...
            let bAtomCondAnion =
                (atom.resn === 'GLU' && (atom.name === 'OE1' || atom.name === 'OE2')) ||
                (atom.resn === 'ASP' && (atom.name === 'OD1' || atom.name === 'OD2')) ||
                (ic.nucleotides.hasOwnProperty(atom.serial) &&
                    (atom.name === 'OP1' || atom.name === 'OP2' || atom.name === 'O1P' || atom.name === 'O2P')) ||
        ...
        for (let i in targetAtoms) {
            ...
            if (bAtomCondCation || bAtomCondAnion) {
                ...
                let otherAtom1 = undefined,
                    resid1 = atom.structure + '_' + atom.chain + '_' + atom.resi
                ...
                let coord1 =
                    otherAtom1 === undefined ? atom.coord : atom.coord.clone().add(otherAtom1.coord).multiplyScalar(0.5)
                ...
                for (let j in atomHbond) {
                    ...
                    let otherAtom2 = undefined,
                        resid2 = atomHbond[j].structure + '_' + atomHbond[j].chain + '_' + atomHbond[j].resi
                    ...
                    let coord2 =
                        otherAtom2 === undefined
                            ? atomHbond[j].coord
                            : atomHbond[j].coord.clone().add(otherAtom2.coord).multiplyScalar(0.5)
