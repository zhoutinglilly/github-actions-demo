...
class Analysis {
    ...
    calcBuriedSurface(nameArray2, nameArray) {
        var ic = this.icn3d,
            me = ic.icn3dui
    ...
    measureDistTwoSets(nameArray, nameArray2) {
        var ic = this.icn3d,
            me = ic.icn3dui
    ...
    addLine(x1, y1, z1, x2, y2, z2, color, dashed, type) {
        var ic = this.icn3d,
            me = ic.icn3dui
    ...
    addLineFromPicking(type) {
        ...
        me.htmlCls.clickMenuCls.setLogCmd(
            'add line | x1 ' +
                ic.pAtom.coord.x.toPrecision(4) +
                ' y1 ' +
                ic.pAtom.coord.y.toPrecision(4) +
                ' z1 ' +
                ic.pAtom.coord.z.toPrecision(4) +
                ' | x2 ' +
                ic.pAtom2.coord.x.toPrecision(4) +
                ' y2 ' +
                ic.pAtom2.coord.y.toPrecision(4) +
                ' z2 ' +
                ic.pAtom2.coord.z.toPrecision(4) +
                ' | color ' +
                color +
                ' | dashed ' +
                dashed +
    ...
    addLabel(text, x, y, z, size, color, background, type) {
        var ic = this.icn3d,
            me = ic.icn3dui
    ...
    addChainLabels(atoms) {
        ...
        for (let chainid in chainHash) {
            ...
            label.size = size
            let atomColorStr = ic.firstAtomObjCls
                .getFirstCalphaAtomObj(ic.chains[chainid])
                .color.getHexString()
                .toUpperCase()
