...
class AnnoDomain {
    ...
    showDomainWithData(chnid, data) {
        ...
        for (let index = 0, indexl = domainArray.length; index < indexl; ++index) {
            ...
            let htmlTmp2 =
                '<div class="icn3d-seqTitle icn3d-link icn3d-blue" 3ddomain="' +
                (index + 1).toString() +
                '" from="' +
                fromArray +
                '" to="' +
            ...
            if (me.cfg.blast_rep_id != chnid) {
                ...
                for (let i = 0, il = fromArray.length; i < il; ++i) {
                    let emptyWidth =
                        i == 0
                            ? Math.round((ic.seqAnnWidth * (fromArray[i] - ic.baseResi[chnid] - 1)) / ic.maxAnnoLength)
                    ...
                    html2 +=
                        ...
                        'px;" class="icn3d-seqTitle icn3d-link icn3d-blue" 3ddomain="' +
                        (index + 1).toString() +
                        '" from="' +
                        fromArray +
                        '" to="' +
