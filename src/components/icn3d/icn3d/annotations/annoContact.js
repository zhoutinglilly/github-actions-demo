...
class AnnoContact {
    ...
    showInteraction(chnid, chnidBase) {
        let ic = this.icn3d,
            me = ic.icn3dui
        let thisClass = this
        if (
            ic.chainname2residues === undefined &&
    ...
    showInteraction_base(chnid, chnidBase) {
        let ic = this.icn3d,
            me = ic.icn3dui
        // set interaction
        ...
        if (ic.chainname2residues[chainid] === undefined) {
            ...
            for (let j = 0; j < jl; ++j) {
                ...
                let atomsChainid1 = ic.contactCls.getAtomsWithinAtom(
                    me.hashUtilsCls.hash2Atoms(ic.chains[chainid], ic.atoms),
                    me.hashUtilsCls.hash2Atoms(ic.chains[chainid2], ic.atoms),
                    radius,
                )
        ...
        for (let chainname in ic.chainname2residues[chnid]) {
            ...
            let htmlTmp2 =
                '<div class="icn3d-seqTitle icn3d-link icn3d-blue" interaction="' +
                (index + 1).toString() +
                '" posarray="' +
            ...
            htmlTmp =
                '<span class="icn3d-residueNum" title="residue count">&nbsp;' + resCnt.toString() + ' Residues</span>'
            htmlTmp += '</span>'
            htmlTmp += '<br>'
            html += htmlTmp
            html2 += htmlTmp
