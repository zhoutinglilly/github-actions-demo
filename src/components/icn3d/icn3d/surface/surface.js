...
class Surface {
    ...
    createSurfaceRepresentation(atoms, type, wireframe, opacity) {
        ...
        if (ic.bConsiderNeighbors) {
            ...
            unionAtoms = me.hashUtilsCls.unionHash(
                unionAtoms,
                ic.contactCls.getAtomsWithinAtom(ic.atoms, atoms, distance),
            )
        ...
        let bTransparent =
            parseInt(10 * opacity) != 10 &&
            !wireframe &&
            !(ic.bInstanced && Object.keys(ic.atoms).length * ic.biomtMatrices.length > ic.maxatomcnt)
                ? true
                : false
    ...
    */
        ...
        if (ic.bCalcArea) {
            ...
            html +=
                ...
                structureStr +
                chainStr +
                '<th>Residue</th><th>Number</th><th>SASA (&#8491;<sup>2</sup>)</th><th>Percent Out</th><th>In/Out</th></tr>'
        ...
        if (
            ...
            ic.rmsd_supr !== undefined &&
            ic.rmsd_supr.rot !== undefined
        ) {
        ...
        let bTrans =
            (type == 11 || type == 12 || type == 13 || (type == 14 && ic.loadPhiFrom != 'delphi')) &&
            ic.rmsd_supr !== undefined &&
            ic.rmsd_supr.rot !== undefined
...
*/
        ...
        if (bTransparent) {
            // WebGL has some ordering problem when dealing with transparency
            ...
            for (let va in va2faces) {
                ...
                mesh.onBeforeRender = function (renderer, scene, camera, geometry, material, group) {
                    ...
                    if (ic.bControlGl && !me.bNode) {
                        ...
                        realPos = sum
                            .multiplyScalar(3.0 / vertices.length)
                            .sub(ic.oriCenter)
                            .applyMatrix4(window.cam.matrixWorldInverse)
                    } else {
    ...
    transformMemPro(inCoord, rot, centerFrom, centerTo, bOut) {
        let ic = this.icn3d,
            me = ic.icn3dui
