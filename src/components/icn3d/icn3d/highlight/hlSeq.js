...
class HlSeq {
    ...
    selectSequenceNonMobile() {
        ...
        let thisClass = this
        $('#' + ic.pre + 'dl_sequence2')
            .add('[id^=' + ic.pre + 'dt_giseq]')
            .add('[id^=' + ic.pre + 'dt_custom]')
            .add('[id^=' + ic.pre + 'dt_site]')
            .add('[id^=' + ic.pre + 'dt_snp]')
            .add('[id^=' + ic.pre + 'dt_clinvar]')
            .add('[id^=' + ic.pre + 'dt_cdd]')
            .add('[id^=' + ic.pre + 'dt_domain]')
            .add('[id^=' + ic.pre + 'dt_interaction]')
            .add('[id^=' + ic.pre + 'dt_ssbond]')
            .add('[id^=' + ic.pre + 'dt_crosslink]')
            .add('[id^=' + ic.pre + 'dt_transmem]')
            .add('[id^=' + ic.pre + 'tt_giseq]')
            .add('[id^=' + ic.pre + 'tt_custom]')
            .add('[id^=' + ic.pre + 'tt_site]')
            .add('[id^=' + ic.pre + 'tt_snp]')
            .add('[id^=' + ic.pre + 'tt_clinvar]')
            .add('[id^=' + ic.pre + 'tt_cdd]')
            .add('[id^=' + ic.pre + 'tt_domain]')
            .add('[id^=' + ic.pre + 'tt_interaction]')
            .add('[id^=' + ic.pre + 'tt_ssbond]')
            .add('[id^=' + ic.pre + 'tt_crosslink]')
            .add('[id^=' + ic.pre + 'tt_transmem]')
            .selectable({
                stop: function () {
        ...
        $('[id^=' + ic.pre + 'ov_giseq]')
            .add('[id^=' + ic.pre + 'ov_custom]')
            .add('[id^=' + ic.pre + 'ov_site]')
            .add('[id^=' + ic.pre + 'ov_snp]')
            .add('[id^=' + ic.pre + 'ov_clinvar]')
            .add('[id^=' + ic.pre + 'ov_cdd]')
            .add('[id^=' + ic.pre + 'ov_domain]')
            .add('[id^=' + ic.pre + 'ov_interaction]')
            .add('[id^=' + ic.pre + 'ov_ssbond]')
            .add('[id^=' + ic.pre + 'ov_crosslink]')
            .add('[id^=' + ic.pre + 'ov_transmem]')
            .add('[id^=' + ic.pre + 'tt_giseq]')
            .add('[id^=' + ic.pre + 'tt_custom]')
            .add('[id^=' + ic.pre + 'tt_site]')
            .add('[id^=' + ic.pre + 'tt_snp]')
    ...
    selectSequenceMobile() {
        ...
        $('#' + ic.pre + 'dl_sequence2')
            .add('[id^=' + ic.pre + 'giseq]')
            .add('[id^=' + ic.pre + 'custom]')
            .add('[id^=' + ic.pre + 'site]')
            .add('[id^=' + ic.pre + 'clinvar]')
            .add('[id^=' + ic.pre + 'snp]')
            .add('[id^=' + ic.pre + 'cdd]')
            .add('[id^=' + ic.pre + 'domain]')
            .add('[id^=' + ic.pre + 'interaction]')
            .add('[id^=' + ic.pre + 'ssbond]')
            .add('[id^=' + ic.pre + 'crosslink]')
            .add('[id^=' + ic.pre + 'transmem]')
            .on('click', '.icn3d-residue', function (e) {
                let ic = thisClass.icn3d
                e.stopImmediatePropagation()
        ...
        if ($(that).hasClass('icn3d-seqTitle')) {
            ...
            if ($(that).hasClass('icn3d-highlightSeq')) {
                if (!ic.bAnnotations) {
                    ...
                    if (ic.currSelectedSets.length > 1)
                        me.htmlCls.clickMenuCls.setLogCmd('select sets ' + setNames, true)
                } else {
                    if ($(that).hasClass('icn3d-highlightSeq')) {
                        ic.hlUpdateCls.removeHl2D()
                        ...
                        if ($(that).attr('gi') !== undefined) {
                            ...
                            let residueidHash = {}
                            if (
                                $(that).attr('domain') !== undefined ||
                                $(that).attr('feat') !== undefined ||
                                $(that).attr('3ddomain') !== undefined ||
                                $(that).attr('custom') !== undefined
                            ) {
                                ...
                                position = ic.applyCenterCls.centerAtoms(
                                    me.hashUtilsCls.hash2Atoms(ic.residues[residueid], ic.atoms),
                                )
                            }
                            ...
                            me.htmlCls.clickMenuCls.setLogCmd(
                                'select ' +
                                    ic.resid2specCls.residueids2spec(Object.keys(residueidHash)) +
                                    ' | name ' +
                                    commandname,
                                true,
                            )
