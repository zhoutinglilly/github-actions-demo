...
class SetColor {
    ...
    setColorByOptions(options, atoms, bUseInputColor) {
        let ic = this.icn3d,
            me = ic.icn3dui
                ...
                switch (options.color.toLowerCase()) {
                    case 'spectrum':
                        ...
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.atomColors[atom.elem] || me.parasCls.defaultAtomColor
                                : me.parasCls.thr().setHSL((3 / 4) * (1 - idx++ * lastTerSerialInv), 1, 0.45)
                    ...
                    case 'rainbow':
                        ...
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.atomColors[atom.elem] || me.parasCls.defaultAtomColor
                                : me.parasCls.thr().setHSL((3 / 4) * idx++ * lastTerSerialInv, 1, 0.45)

                            ic.atomPrevColors[i] = atom.color
                        }
                        break
                    case 'chain':
                        if (ic.chainsColor !== undefined && Object.keys(ic.chainsColor).length > 0) {
                            // mmdb input
                            this.setMmdbChainColor()
                        } else {
                            let index = -1,
                                prevChain = '',
                                colorLength = me.parasCls.stdChainColors.length
                            for (let i in atoms) {
                                let atom = ic.atoms[i]
                    ...
                    case 'secondary structure green':
                        ...
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.atomColors[atom.elem] || me.parasCls.defaultAtomColor
                                : me.parasCls.ssColors[atom.ss] || me.parasCls.thr(0xff00ff)
                    ...
                    case 'secondary structure':
                        ...
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.atomColors[atom.elem] || me.parasCls.defaultAtomColor
                                : me.parasCls.ssColors2[atom.ss] || me.parasCls.thr(0xff00ff)
                    ...
                    case 'secondary structure spectrum':
                        ...
                        for (let i in atoms) {
                            ...
                            if (
                                prevI != -9999 &&
                                (atom.ss != prevAtom.ss ||
                                    Math.abs(atom.resi - prevAtom.resi) > 1 ||
                                    (atom.ssbegin && prevAtom.ssend))
                            ) {
                                if (prevAtom.ss == 'coil') {
...
*/
                    ...
                    case 'residue':
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.atomColors[atom.elem] || me.parasCls.defaultAtomColor
                                : me.parasCls.residueColors[atom.resn] || me.parasCls.defaultResidueColor
                    ...
                    case 'residue custom':
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.atomColors[atom.elem] || me.parasCls.defaultAtomColor
                                : ic.customResidueColors[atom.resn] || me.parasCls.defaultResidueColor
                    ...
                    case 'align custom':
                        ...
                        for (let serial in atoms) {
                            ...
                            if (ic.queryresi2score === undefined || !ic.queryresi2score.hasOwnProperty(chainid))
                                continue
                            ...
                            if (ic.queryresi2score[chainid].hasOwnProperty(queryresi)) {
                                ...
                                if (b < ic.middB) {
                                    if (ic.startColor == 'blue') {
                                        color =
                                            ic.midColor == 'white'
                                                ? me.parasCls.thr().setRGB(1 - s1, 1 - s1, 1)
                                                : me.parasCls.thr().setRGB(0, 0, s1)
                                    } else if (ic.startColor == 'red') {
                                        color =
                                            ic.midColor == 'white'
                                                ? me.parasCls.thr().setRGB(1, 1 - s1, 1 - s1)
                                                : me.parasCls.thr().setRGB(s1, 0, 0)
                                    } else if (ic.startColor == 'green') {
                                        color =
                                            ic.midColor == 'white'
                                                ? me.parasCls.thr().setRGB(1 - s1, 1, 1 - s1)
                                                : me.parasCls.thr().setRGB(0, s1, 0)
                                    }
                                } else {
                                    if (ic.endColor == 'red') {
                                        color =
                                            ic.midColor == 'white'
                                                ? me.parasCls.thr().setRGB(1, 1 - s2, 1 - s2)
                                                : me.parasCls.thr().setRGB(s2, 0, 0)
                                    } else if (ic.endColor == 'green') {
                                        color =
                                            ic.midColor == 'white'
                                                ? me.parasCls.thr().setRGB(1 - s2, 1, 1 - s2)
                                                : me.parasCls.thr().setRGB(0, s2, 0)
                                    } else if (ic.endColor == 'blue') {
                                        color =
                                            ic.midColor == 'white'
                                                ? me.parasCls.thr().setRGB(1 - s2, 1 - s2, 1)
                                                : me.parasCls.thr().setRGB(0, 0, s2)
                                    }
                                }
                            } else {
                    ...
                    case 'charge':
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.defaultAtomColor
                                : me.parasCls.chargeColors[atom.resn] || me.parasCls.defaultResidueColor
                    ...
                    case 'hydrophobic':
                        for (let i in atoms) {
                            ...
                            atom.color = atom.het
                                ? me.parasCls.defaultAtomColor
                                : me.parasCls.hydrophobicColors[atom.resn] || me.parasCls.defaultResidueColor
                    ...
                    case 'confidence':
                        for (let i in atoms) {
                            let atom = ic.atoms[i]
                            if (atom.b === undefined || parseInt(atom.b * 1000) == 0) {
                                // invalid b-factor
                                ...
                                if (b >= 90) {
                                    ...
                                    atom.color = me.parasCls.thr().setRGB(1, 0.49, 0.271)
                                }
                            }
                    ...
                    case 'b factor percentile':
                        ...
                        if (!ic.bfactorArray) {
                            ...
                            ic.bfactorArray.sort(function (a, b) {
                                return a - b
                            })
                        }
                        ...
                        for (let i in atoms) {
                            let atom = ic.atoms[i]
                            if (atom.b === undefined || parseInt(atom.b * 1000) == 0 || ic.bfactorArray.length == 0) {
                                // invalid b-factor
                                atom.color = me.parasCls.thr().setRGB(0, 1, 0)
                            } else {
                                ...
                                atom.color =
                                    percentile < 0.5
                                        ? me.parasCls.thr().setRGB(percentile * 2, percentile * 2, 1)
                                        : me.parasCls.thr().setRGB(1, (1 - percentile) * 2, (1 - percentile) * 2)
                            }
                    ...
                    case 'area':
                        ...
                        for (let i in atoms) {
                            ...
                            let b = me.parasCls.residueArea.hasOwnProperty(atom.resn)
                                ? (ic.resid2area[resid] / me.parasCls.residueArea[atom.resn]) * 100
                                : middB
                    ...
                    default:
                        // the "#" was missed in order to make sharelink work
                        for (let i in atoms) {
                            let atom = ic.atoms[i]
                            atom.color = me.parasCls.thr().setStyle('#' + options.color.toLowerCase())
    ...
    updateChainsColor(atom) {
        let ic = this.icn3d,
            me = ic.icn3dui
        let chainid = atom.structure + '_' + atom.chain
        if (ic.chainsColor[chainid] !== undefined) {
            // for mmdbid and align input
            ic.chainsColor[chainid] = atom.color
        }
    }

    setMmdbChainColor(inAtoms) {
        let ic = this.icn3d,
            me = ic.icn3dui
    ...
    setConservationColor(atoms, bIdentity) {
        let ic = this.icn3d,
            me = ic.icn3dui
            ...
            for (let i = 0, il = resObjectArray.length; i < il; ++i) {
                ...
                for (let j in ic.residues[residueid]) {
                    if (atoms.hasOwnProperty(j)) {
                        let color = bIdentity
                            ? me.parasCls.thr(resObjectArray[i].color)
                            : me.parasCls.thr(resObjectArray[i].color2)
    ...
    setOutlineColor(colorStr) {
        ...
        if (colorStr === 'yellow') {
            shader.outline.fragment_shader = ['void main(){', 'gl_FragColor = vec4( 1.0, 1.0, 0.0, 1.0 );', '}'].join(
                '\n',
            )
        } else if (colorStr === 'green') {
            shader.outline.fragment_shader = ['void main(){', 'gl_FragColor = vec4( 0.0, 1.0, 0.0, 1.0 );', '}'].join(
                '\n',
            )
        } else if (colorStr === 'red') {
            shader.outline.fragment_shader = ['void main(){', 'gl_FragColor = vec4( 1.0, 0.0, 0.0, 1.0 );', '}'].join(
                '\n',
            )
        }
