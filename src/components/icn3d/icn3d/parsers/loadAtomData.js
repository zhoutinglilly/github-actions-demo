...
class LoadAtomData {
    ...
    loadAtomDataIn(data, id, type, seqalign, alignType, chainidInput, chainIndex, bLastQuery) {
        let ic = this.icn3d,
            me = ic.icn3dui
        //ic.init();
        ...
        for (let i in atoms) {
            ...
            if (type === 'mmdbid') {
                ...
                if (ic.q_rotation !== undefined && ic.t_trans_add.length > 0 && !me.cfg.resnum && !me.cfg.resdef) {
                    if (alignType === 'target') {
                        ...
                        let x =
                            atm.coord.x * ic.q_rotation[chainIndex].x1 +
                            atm.coord.y * ic.q_rotation[chainIndex].y1 +
                            atm.coord.z * ic.q_rotation[chainIndex].z1
                        let y =
                            atm.coord.x * ic.q_rotation[chainIndex].x2 +
                            atm.coord.y * ic.q_rotation[chainIndex].y2 +
                            atm.coord.z * ic.q_rotation[chainIndex].z2
                        let z =
                            atm.coord.x * ic.q_rotation[chainIndex].x3 +
                            atm.coord.y * ic.q_rotation[chainIndex].y3 +
                            atm.coord.z * ic.q_rotation[chainIndex].z3
            ...
            if ((type === 'mmdbid' || type === 'align') && ic.bFullUi) {
                ...
                ic.mmdbMolidResid2mmdbChainResi[mmdbId + '_' + atm.ids.m + '_' + atm.ids.r] =
            ...
            let bChemicalIons =
                me.cfg.mmcifid === undefined && ic.InputfileType != 'mmcif'
                    ? chainid2kind[chainNum] === 'ligand' ||
                      (chainid2kind[chainNum] !== undefined && chainid2kind[chainNum].indexOf('other') !== -1) ||
            ...
            if (bProtein || bNucleotide) {
                if (bProtein) {
                    ...
                    if (atm.name !== 'N' && atm.name !== 'CA' && atm.name !== 'C' && atm.name !== 'O')
                        ic.sidec[serial] = 1
                } else if (bNucleotide) {
