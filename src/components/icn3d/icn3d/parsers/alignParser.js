...
class AlignParser {
    ...
    downloadAlignment(align) {
        ...
        let chained = request
            ...
            .then(function (data) {
                ...
                let url3 =
                    me.htmlCls.baseUrl + 'mmdb/mmdb_strview.cgi?v=2&program=icn3d&b=1&s=1&ft=1&uid=' + ic.mmdbidArray[0]
                let url4 =
                    me.htmlCls.baseUrl + 'mmdb/mmdb_strview.cgi?v=2&program=icn3d&b=1&s=1&ft=1&uid=' + ic.mmdbidArray[1]
                ...
                $.when(d3, d4).then(function (v3, v4) {
                    ...
                    if (data3.atoms !== undefined && data4.atoms !== undefined) {
                        ic.deferredOpm = $.Deferred(function () {
                            ...
                            ic.ParserUtilsCls.setYourNote(
                                (ic.mmdbidArray[0] + ',' + ic.mmdbidArray[1]).toUpperCase() + '(VAST+) in iCn3D',
                            )
                            ...
                            let tMVector = new THREE.Vector3(
                                tMaster[0] / factor,
                                tMaster[1] / factor,
                                tMaster[2] / factor,
                            )
                            ...
                            let rMatrix = []
                            for (let i = 0, il = rotation.length; i < il; ++i) {
                                // 9 elements
    ...
    downloadAlignmentPart2(data, seqalign, chainresiCalphaHash2) {
        let ic = this.icn3d,
            me = ic.icn3dui
        //ic.init();
    ...
    loadOpmDataForAlign(data, seqalign, mmdbidArray) {
        let ic = this.icn3d,
            me = ic.icn3dui
        let thisClass = this
