...
class SetSeqAlign {
    ...
    setSeqAlign(seqalign, alignedStructures) {
        let ic = this.icn3d,
            me = ic.icn3dui
        //loadSeqAlignment
        let alignedAtoms = {}
        ...
        for (let i = 0, il = seqalign.length; i < il; ++i) {
            ...
            let id2aligninfo = {}
            let start = alignData.sequence.length,
                end = -1
            let bStart = false
            ...
            for (let j = start; j <= end; ++j) {
                ...
                resObject.resn =
                    resObject.resi === '' || classname === 'icn3d-nalign'
                        ? id2aligninfo[j].resn.toLowerCase()
                        : id2aligninfo[j].resn
    ...
    setSeqAlignChain(chainid, chainIndex) {
        let ic = this.icn3d,
            me = ic.icn3dui
        //loadSeqAlignment
        let alignedAtoms = {}
        ...
        for (let i = 0, il = ic.qt_start_end[chainIndex].length; i < il; ++i) {
            ...
            for (let j = 0; j <= end1 - start1; ++j) {
                ...
                if (
                    ic.chainsSeq[chainid1][j + start1] === undefined ||
                    ic.chainsSeq[chainid2][j + start2] === undefined
                )
                    continue
    ...
    setSeqAlignForRealign(chainid_t, chainid, chainIndex) {
        let ic = this.icn3d,
            me = ic.icn3dui
        //loadSeqAlignment
        let alignedAtoms = {}
    ...
    setSeqPerResi(
        ...
        if (bFirstChain) {
            ...
            if (bFirstResi) {
                ...
                let title1 =
                    ic.pdbid_chain2title && ic.pdbid_chain2title.hasOwnProperty(chainid2)
                        ? ic.pdbid_chain2title[chainid2]
                        : ''
                let title2 =
                    ic.pdbid_chain2title && ic.pdbid_chain2title.hasOwnProperty(chainid)
                        ? ic.pdbid_chain2title[chainid]
                        : ''
