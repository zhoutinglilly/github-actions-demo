...
class LoadPDB {
    ...
    */
    ...
    adjustSeq(chainMissingResidueArray) {
        let ic = this.icn3d,
            me = ic.icn3dui
        // adjust sequences
    ...
    getChainCalpha(chains, atoms, bResi_ori, pdbid) {
        let ic = this.icn3d,
            me = ic.icn3dui
        let chainCalphaHash = {}
        ...
        for (let chainid in chains) {
            ...
            for (let i = 0, il = serialArray.length; i < il; ++i) {
                ...
                if (
                    (ic.proteins.hasOwnProperty(serialArray[i]) && atom.name == 'CA') ||
