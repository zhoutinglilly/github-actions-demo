    ...
    loadMol2AtomData(data) {
        ...
        for (let i = 0, il = lines.length; i < il; ++i) {
            ...
            if (bBondSection && bondIndex < bondCount) {
                ...
                if (
                    !skipAtomids.hasOwnProperty(fromAtomid) &&
                    !skipAtomids.hasOwnProperty(toAtomid) &&
                    (finalBondType === '1' || finalBondType === '2' || finalBondType === '3' || finalBondType === '1.5')
                ) {
