...
class FirstAtomObj {
    ...
    getFirstCalphaAtomObj(atomsHash) {
        let ic = this.icn3d,
            me = ic.icn3dui
        if (atomsHash === undefined || Object.keys(atomsHash).length === 0) {
            return undefined
    ...
    getFirstAtomObjByName(atomsHash, atomName) {
        let ic = this.icn3d,
            me = ic.icn3dui
        if (atomsHash === undefined || Object.keys(atomsHash).length === 0) {
            return ic.atoms[0]
    ...
    getResiduesFromAtoms(atomsHash) {
        let ic = this.icn3d,
            me = ic.icn3dui
        let residuesHash = {}
        for (let i in atomsHash) {
    ...
    getResiduesFromCalphaAtoms(atomsHash) {
        let ic = this.icn3d,
            me = ic.icn3dui
        let residuesHash = {}
        for (let i in atomsHash) {
    ...
    getAtomFromResi(resid, atomName) {
        let ic = this.icn3d,
            me = ic.icn3dui
    ...
    getAtomCoordFromResi(resid, atomName) {
        let ic = this.icn3d,
            me = ic.icn3dui
