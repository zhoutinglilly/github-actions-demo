...
class CurveStripArrow {
    ...
    prepareStrand(
        ...
        let colorsTmp = []
        let i,
            lastIndex = bShowArrow === undefined || bShowArrow ? pntsCA.length - 2 : pntsCA.length
        ...
        if (bShowArrow === undefined || bShowArrow) {
            ...
            for (let i = 0, il = positions.length; i < il; ++i) {
                ...
                v = new THREE.Vector3(
                    pntsCASmooth[lastCAIndex].x + prevCOArray[lastPrevCOIndex].x * delta,
        ...
        if (bShowArrow === undefined || bShowArrow) {
            ...
            for (let index = 0, indexl = positions.length; index < indexl; ++index) {
                ...
                for (
                    let i = div * (pntsCA.length - 2), il = div * (pntsCA.length - 1);
                    bShowArray[parseInt(i / div)] && i < il;
                    i = i + div
                ) {
                    ...
                    for (let j = 0; j < div; ++j) {
                        ...
                        let v = new THREE.Vector3(
                            pntsCASmooth[i + j].x + prevCOArray[oriIndex].x * delta,
