...
class Line {
        ...
        if (bHighlight !== 2) {
            ...
            if (bHighlight === 1) {
                ...
                line = new THREE.LineSegments(
                    geo,
                    new THREE.LineBasicMaterial({linewidth: ic.linewidth, vertexColors: true}),
                )
                ic.mdl.add(line)
            }
    ...
    createConnCalphSidechain(atoms, style) {
        let ic = this.icn3d,
            me = ic.icn3dui
        if (me.bNode) return
    ...
    createSingleLine(src, dst, colorHex, dashed, dashSize) {
        let ic = this.icn3d,
            me = ic.icn3dui
        if (me.bNode) return
