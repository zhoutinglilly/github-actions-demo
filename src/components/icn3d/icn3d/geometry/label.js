    ...
    makeTextSprite(message, parameters) {
        ...
        if (parameters.hasOwnProperty('backgroundColor') && parameters['backgroundColor'] !== undefined) {
            ...
            borderColor = parameters.hasOwnProperty('borderColor')
                ? me.utilsCls.hexToRgb(parameters['borderColor'], a)
                : {r: 0, g: 0, b: 0, a: 1.0}
        ...
        let textAlpha = 1.0
        let textColor =
            parameters.hasOwnProperty('textColor') && parameters['textColor'] !== undefined
                ? me.utilsCls.hexToRgb(parameters['textColor'], textAlpha)
