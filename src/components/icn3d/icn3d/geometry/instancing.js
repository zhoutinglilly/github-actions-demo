...
*/
    ...
    drawSymmetryMatesNoInstancing() {
        ...
        for (let i = 0; i < ic.biomtMatrices.length; i++) {
            // skip itself
...
*/
    ...
    createInstancedGeometry(mesh) {
        ...
        if (ic.bImpo && mesh.type == 'Cylinder') {
            // cylinder
        ...
        else if (ic.bImpo && mesh.type == 'Sphere') {
            // sphere
        ...
        //if( baseGeometry.vertices && baseGeometry.faces ){
            ...
            let positionArray2 = baseGeometry.attributes.position
                ? me.hashUtilsCls.hashvalue2array(baseGeometry.attributes.position.array)
                : []
            let normalArray2 = baseGeometry.attributes.normal
                ? me.hashUtilsCls.hashvalue2array(baseGeometry.attributes.normal.array)
                : []
            let colorArray2 = baseGeometry.attributes.color
                ? me.hashUtilsCls.hashvalue2array(baseGeometry.attributes.color.array)
                : []
